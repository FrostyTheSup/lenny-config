...
export PATH=$HOME/bin:/usr/local/bin:$PATH:$HOME/.local/bin:$HOME/git-scripts
...
alias fix-audio='pactl set-sink-volume @DEFAULT_SINK@ 50%; pactl set-sink-mute @DEFAULT_SINK@ false'
